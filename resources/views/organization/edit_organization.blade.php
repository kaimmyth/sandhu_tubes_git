                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" min="1" class="form-control" name="revenue" value="{{$organizationtdata->revenue}}" id="revenue" placeholder="Revenue">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="role" value="{{$organizationtdata->contact_role}}" id="role" placeholder="Role">
                              </div>
                            </div>
                          </div>
