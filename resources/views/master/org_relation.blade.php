            ...
            <div class="row" id="dashboard-row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li><a href="{{URL::to('home')}}">Relationship</a></li>
                    ...
                    <div class="col-xl-12">
                        <div class="portlet">
                            ...
                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    @foreach($result_relation as $key => $value)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        ...
                                        @endif
                                        <td class="actions">
                                            <a href="javascript::void(0)" class="on-default edit-row" onclick="editRecords({{$value['org_relation_id']}})" data-toggle="tooltip" data-modal="modal-12" data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="{{ URL::to('org/org_relationship',$value['org_relation_id'])}}" class="on-default remove-row" onclick="return confirm('Are you sure you want to delete this item?');" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fas fa-trash" style="color:red;"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
...
<div id="convertion-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('org/org_relationship/add') }}" method="POST" id="FormValidation" enctype="multipart/form-data" autocomplete="off">
                @csrf
...
<script>
    function editRecords(id) {
        ...
        $.ajax({
            url: "{{url('org/org_relationship/edit/')}}" + '/' + id,
            method: "POST",
