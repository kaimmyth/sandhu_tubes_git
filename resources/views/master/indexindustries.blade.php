<div class="content-page"> 
          ...
          <div class="row" id="dashboard-row">
             <div class="col-sm-12">
                ...
                <ol class="breadcrumb pull-right">
                   ...
                   <li class="active">Industries MASTER</li>
                </ol>
             </div>
          </div><hr class="new2">
          <div class="row">
                ...
                <div class="card card-border card-info">
                   <div class="card-header" style="background-image: linear-gradient(#e9f8ff, white);">
                      ...
                      <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                         ...
                         <tbody>
                            @foreach($industriesData as $key => $data)
                            <tr>
                               <td>{{ $key+1 }}</td>
                               <td>{{$data->industires_name}}</td>
                               <td>{{$data->industires_description}}</td>
                               @if($data->status == 1)
                               <td>
                                  <p class="mb-0">
                               ...
                               <td class="actions">
                                  ...
                                  &nbsp;&nbsp;&nbsp;
                                  <!-- <a href="{{ URL::to('industries_master/destroy',$data->id)}}" class="on-default remove-row" onclick="return confirm('Are you sure you want to delete this item?');" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fas fa-trash" style="color:red;"></i></a> -->
                                  <a href="{{url('industries_master/destroy/'.$data->id)}}" class="on-default"    data-original-title="Delete"><i class="fas fa-trash" style="color:red;"></i></a>
                                </td>
                            </tr>
                            @endforeach
                         </tbody>
 ...
 <div id="industries-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
       <div class="modal-content">
          ...
          <form  action="{{ url('add/industries_master') }}" method="POST" id="FormValidation" enctype="multipart/form-data">
             @csrf
 ...
 <script type="text/javascript">
    function editRecords(id) { 
     ...
     $.ajax({
      url:"{{url('industries_master/edit/')}}"+'/'+id,  
      method:"POST", 
