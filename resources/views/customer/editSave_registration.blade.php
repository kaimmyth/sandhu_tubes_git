              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="row form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control datepicker" value="{{$toReturn['lease_details']->application_date}}" onchange="chkdate(this.value)" id="appliDate"  name="application_date">
                    </div>
                  </div> 
                </div>
              </div>
              <div class="row">
               <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control  datepicker selector" value="{{$toReturn['lease_details']->possession_date}}"   name="possession_date"  placeholder="DD/MM/YYYY">
                  </div>
                </div> 
              </div>
              <div class="col-md-5">
            ...
            <div class="row">              
              ...
              <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control datepicker " value="{{$toReturn['lease_details']->registration_date}}" name="registration_date" placeholder="">
                  </div>
                </div> 
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control datepicker " name="allotment_date" value="{{$toReturn['lease_details']->allotment_date}}"  aria-required="true" >
                  </div>
                </div> 
              </div>
            </div>
