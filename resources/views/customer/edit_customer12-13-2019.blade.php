              ...
              <span class="input-group-prepend">
                <button type="button" class="btn waves-effect waves-light btn-primary"><i class="fa fa-search"></i></button>&nbsp;
                                                          ...
                                                          <div class="col-sm-12">
                                                              ...
                                                              <div class="row">
                                                                  <div class="col-md-3">
                                                                      <div class="form-group">
                                                                          <label for="field-1" class="control-label">Contact</label>
                                                                          <input type="text" class="form-control" name="shareholder_contact[]" id="" value="{{@$value['mobile'] ?? ''}}" placeholder=""  aria-required="true">
                                                                      </div>
                                                                  </div>
                                                                  <div class="col-md-3">
                                                                      <div class="form-group">
                                                                          <label for="field-1" class="control-label">Email Id</label>
                                                                          <input type="text" class="form-control" name="shareholder_email_id[]" id="" value="{{@$value['email'] ?? ''}}" placeholder=""  aria-required="true">
                                                                      </div>
                                                                  </div>
                                                                  <div class="col-md-3">
                                                                      <div class="form-group">
                                                                          <label for="field-1" class="control-label">Share Value</label>
                                                                          <input type="text" class="form-control" name="shareholder_share_value[]" id="" value="{{@$value['svalue'] ?? ''}}" placeholder=""  aria-required="true">
                                                                      </div>
                                                                  </div>
                                                                  ...
                                                                  <div class="col-md-3">
                                                                      <div class="form-group">
                                                                          <label for="field-1" class="control-label">Share Value (%)</label>
                                                                          <input type="text" class="form-control" name="shareholder_share_per[]" id="" value="{{@$value['svalue_percentage'] ?? ''}}" placeholder=""  aria-required="true">
                                                                      </div>
                                                                  </div>
                                                              </div>
                                                              <div class="row" style="margin-left: 1px;">
                                                              ...
                                                              <div class="form-group no-margin">
                                                                  <label for="field-7" class="control-label">Address</label>
                                                                  <textarea class="form-control autogrow" name="shareholderaddress[]" id="address" placeholder="Write your address here...." style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px"  value="{{@$value['location'] ?? ''}}"></textarea>
                                                              </div>
                                                          </div>
                                                      </div>
                                                      @endforeach
                                  ...
                                  <div class="col-md-12" style="    text-align: left; margin-bottom: 6px;">
                                      <button type="submit" class="btn btn-primary waves-effect waves-light" onclick="return company_share_value()">@if(@$edit_company->id!='') Update @else Create @endif</button>
                                  </div>
                              </form>
               ...
               <div id="item" style="margin-top: 1em;">
                      <div class="col-sm-12">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="row" style="margin-left: 1px;">
                          <div class="radio radio-info form-check-inline">
                            <input type="radio" id="inlineRadio1" value="male" name="shareholdergender[` + i + `]" checked="checked">
                            <label for="inlineRadio1">Male</label>
                          </div>
                          <div class="radio form-check-inline">
                            <input type="radio" id="inlineRadio2" value="female" name="shareholdergender[` + i + `]">
                            <label for="inlineRadio2">Female</label>
                          </div>
                        </div><br>
