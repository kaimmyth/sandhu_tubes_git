                ...
                <div class="row" id="dashboard-row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title" style="color: #000; font-weight:200;"><i
                                class="ion-arrow-right-b"></i> &nbsp;&nbsp; Update Customer Info/ <a href="javascript::void(0);"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="field-6" class="control-label">Unit Name
                                                    <font color="red">*</font></label>
                                                <input type="text" class="form-control" value="{{$edit_company->company ?? ''}}" name="company" id="company" required="" aria-required="true" placeholder="" style="width:100%;">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="field-6" class="control-label">Unit Reg. No <font color="red">*</font></label>
                                                <input type="text" class="form-control" value="{{$edit_company->company_reg_no ?? ''}}" name="company_reg_no" id="company_reg_no" required="" aria-required="true" placeholder="" style="width:100%;">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group no-margin">
                                                <label for="field-7" class="control-label">Unit Address</label>
                                                <textarea class="form-control autogrow address" rows="9" name="company_addrerss" id="address" placeholder="Write your address here...." style="overflow: hidden; word-wrap: break-word; resize: horizontal;">{{$edit_company->address}}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="    margin-top: -12em;">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="turn_over" min="1" id="turn_over" value="{{$edit_company->turn_over}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="number_of_employees" id="number_of_employees" min="1" value="{{$edit_company->number_of_employees}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="    margin-top: -0em;">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control dateFilter" name="established_date" id="dob" placeholder="DD-MM-YYYY" value="@if($edit_company->established_date) {{date('d-m-Y',strtotime($edit_company->established_date))}} @endif">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <br>
                                                ...
                                                <(count($input_detailsArray));$i++) <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="input_details[]" id="input_details">
                                                            ...
                                                            <option @if(@$edit_company->
                                                                input_details_id==$edit_material->id) {{'selected'}} @endif value="{{$edit_material->id}}"> {{$edit_material->material_name}}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                    ...
                                    <div class="col-md-5">
                                        <table class="table">
                                            ...
                                            @if(count($waste_materialsArray)!=0)
                                                ...
                                                @for($i=0;$i<(count($waste_materialsArray));$i++) 
                                                <tr>
                                                    <td>
                                                        <select class="form-control" name="waste_materials[]" id="waste_materials">
                                                            ...
                                                            @foreach($edit_materials as $edit_material)
                                                            <option @if(@$edit_company->
                                                                waste_materials_id==$edit_material->id) {{'selected'}} @endif value="{{$edit_material->id}}"> {{$edit_material->material_name}}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </td>
