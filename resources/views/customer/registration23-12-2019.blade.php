                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actions"> &nbsp;&nbsp;&nbsp;&nbsp;
                                                        ...
                                                        <a href="{{url('land/registration_editFetch',$val->id)}}" id="editpm" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update"><i class="fas fa-pencil-alt"></i></a>
                                                       @endif
                                                       @else
                                                       <a href="{{url('land/registration_editFetch',$val->id)}}" id="editpm" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update"><i class="fas fa-pencil-alt"></i></a>
                                                       @endif
