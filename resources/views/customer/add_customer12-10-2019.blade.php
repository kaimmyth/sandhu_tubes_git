          ...
          <div class="card" style="border-left: 3px solid #386900;box-shadow: 4px 4px #b1b1b1;">
            <div class="card-header" style="background: linear-gradient(to left, #bee9fd, #ffffff 50%, #ffffff, #ffffff 75%);">
                                ...
                                <div class="row" style="width: 100%;">
                                  <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="row" style="margin-left: 1px;">
                                      <div class="radio radio-info form-check-inline">
                                        <input type="radio" id="inlineRadio1"  name="shareholdergender[]" checked="checked">
                                        <label for="inlineRadio1">Male</label>
                                      </div>
                                      <div class="radio form-check-inline">
                                        <input type="radio" id="inlineRadio2"  name="shareholdergender[]">
                                        <label for="inlineRadio2">Female</label>
                                      </div>
                                    </div><br>
              ...
              <div class="col-md-12" style="    text-align: left; margin-bottom: 6px;">
                <button type="submit" class="btn btn-primary waves-effect waves-light" onsubmit="company_share_value();">@if(@$editData->id!='') Update @else Create @endif</button>
              </div>
              </form>
        ...
        var data = `                                                
                 <div id="item" style="margin-top: 1em;">
                        <div class="col-sm-12">
                          ...
                          <div class="form-group no-margin">
                            <label for="field-7" class="control-label">Address</label>
                            <textarea class="form-control autogrow" name="shareholderaddress[]" id="address" placeholder="Write your address here...." style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px" required></textarea>
                          </div>
                          <button type="button"  class="button5  btn_remove btn-danger">Remove</button>
                          </div>
                    </div>`;
...
{
  var arr=array();
  arr[]=document.getElementsByName("shareholder_share_per").value;
  alert(arr);
}
</script>
<script>
