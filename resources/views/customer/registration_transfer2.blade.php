        ...
        <div class="card" id="customerList" style="display: none;">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <br><br><br>
              <div class="col-sm-12">
                <div class="table-responsive" id="contrannsfer" style="display: none;">
                    ...
                    <tbody>
                      <form action="{{url('land/ragistration/transfer')}}" method="post">
                        ...
                        <tr>
                          ...
                          <td><span id="customer_email_id"></span> </td>
                          <!--                           <td><input required="" class="dateFilter" type="text" placeholder="dd-mm-yyyy" name="transfer_date"> </td>
-->
                          <td><input required="" class="" type="text" placeholder="Application No" name="application_no"> </td>
                          <td><input required="" class="" type="text" placeholder="Allotment No" name="allotment_no"> </td>
                          <td><input required="" class="" type="text" placeholder="Registration No" name="registration_no"> </td>
                          <td><input required="" class="dateFilter" type="text" placeholder="dd-mm-yyyy" name="application_date"> </td>
                          <td><input required="" class="dateFilter" type="text" placeholder="dd-mm-yyyy" name="allotment_date"> </td>
                          <td><input required="" class="dateFilter" type="text" placeholder="dd-mm-yyyy" name="registration_date"> </td>

                          <td><input required="" class="dateFilter" type="text" placeholder="dd-mm-yyyy" name="pcc_date"> </td>
                          <td><input required="" class="" type="text" placeholder="" name="transfer_amount"> </td>
                          <td><input required="" class="" type="text" placeholder="" name="land_price"> </td>
                          <td><input type="checkbox" name="all_tearm"> </td>
                          <td><button role="button" type="submit" class="btn btn-primary">Transfer</button> </td>
                        </tr>
                      </form>
                    </tbody>
                  </table>
