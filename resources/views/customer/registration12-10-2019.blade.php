                                        ...
                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td class="actions"> &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="javascript::void(0);" class="on-default view-row" data-toggle="tooltip" onclick="View_Registration({{$val->id}})" data-placement="top" title="" data-original-title="View"><i class="fa fa-eye"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="javascript::void(0);" id="editpm" onclick="Edit_Registration({{$val->id}})" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update"><i class="fas fa-pencil-alt"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;<a href="{{url('land/invoice',$val->id)}}" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Download Invoice"><i class="fa fa-download"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="javascript::void(0);" class="on-default remove-row" data-toggle="tooltip" onclick="View_history({{$val->land_id}})" data-placement="top" title="" data-original-title="View History"><i class="fa fa-history"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="javascript::void(0);" class="on-default remove-row" data-toggle="tooltip" onclick="transfer_land({{$val->id}})" data-placement="top" title="" data-original-title="Transfer Land"><i class="fa fa-forward"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        try {
            ...
            function View_Registration(id) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for(var i=0;i<data.ltdpvt.length; i++)
                            {
                                ...
                                $("#customer_details").append("<tr><td>"+data.ltdpvt[i].f_name+data.ltdpvt[i].l_name+"</td><td>"+customer_type+"</td><td>"+data.ltdpvt[i].mobile+"</td><td>"+data.ltdpvt[i].company_name+"</td><td>"+data.ltdpvt[i].email+"</td></tr>");
                            }
                        ...
                        // document.getElementById('e_f_name').innerHTML = data.lease_details.f_name;
                        // document.getElementById('e_l_name').innerHTML = data.lease_details.l_name;
                        // document.getElementById('e_occupation').innerHTML = data.lease_details.occupation;
                        // document.getElementById('e_dob').innerHTML = data.lease_details.dob;
                        // document.getElementById('e_mobile').innerHTML = data.lease_details.mobile;
                        // document.getElementById('e_company').innerHTML = data.lease_details.company;
                        // document.getElementById('e_email').innerHTML = data.lease_details.email;
                        // document.getElementById('e_gender').innerHTML = data.lease_details.gender;
                        ...
                        var lduration = data.leasedata.lease_duration;

                        $("#ViewTrans").css("display", "block");
                        $("#EditTrans").css("display", "none");
                        $("#submitbtndiv").css("display", "none");

                        // document.getElementById('v_based_rent').innerHTML = baserent;
                        // document.getElementById('v_taxes').innerHTML = tax;
                        // document.getElementById('v_insurance').innerHTML = insurance;
                        // document.getElementById('v_maintanance').innerHTML = maintanance;
                        // document.getElementById('v_additional_charge').innerHTML = addCharge;
                        // document.getElementById('v_netpaybill').innerHTML = netPayable;
                        // document.getElementById('v_netpay').innerHTML = netPay;
                        // document.getElementById('v_yers').innerHTML = lTime;
                        // document.getElementById('v_lease_duration').innerHTML = lduration;
                        // document.getElementById('v_start_date').innerHTML = Sdate;
            ...
            function View_history(land_id) {
                ...
                $.ajax({
                    url: "{{url('land/registration/history/')}}" + '/' + land_id,
                    method: "get",
                    contentType: 'application/json',
                    success: function (data) {
                        console.log(data);
            ...
            function transfer_land(land_id) {
                ...
                $.ajax({
                    url: "{{url('land/transfer_land')}}" + '/' + land_id,
                    method: "get",
                    contentType: 'application/json',
                    success: function (data) {
                        console.log(data);
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="LeaseView" role="tabpanel" aria-labelledby="message-tab-2">
                                        ...
                                        <div class="col-md-12">
                                           ...
                                           <div id="ViewTrans" style="display: none;" class="col-md-12">
                                            <table class="table" style="font-size:10px">
                                                <thead>
                                                    <tr>
                                                    <th>Based Rent</th>
  ...
  function addtransfercustomer(id) {
    ...
    $.ajax({
      ...
      success: function(data) {
        console.log(data)
        $("#modelloader").css("display", "none");
        var name = document.getElementById('customer_name').innerText = data.customer.f_name + ' ' + data.customer.l_name;
        var email = document.getElementById('customer_email_id').innerText = data.customer.email;
        var phone = data.customer.mobile;
        ...
        document.getElementById("custo_id").value = data.customer.id;
