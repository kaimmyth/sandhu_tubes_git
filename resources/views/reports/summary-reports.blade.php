            ...
            <form method="post" action="{{url('generate/summary-report')}}" autocomplete="off" id="summary_report">
                ...
                <div class="row" style="width: 100%; margin-left: 0px;">
                    ...
                    <div class="col-xl-2">
                        ...
                        <a href="#">
                            <button id="prtbtn" onclick="printDiv('datatable ')" class="btn btn-primary" style="margin-top:30px;">Print</button>
                        </a>
                        @endif
                    </div>
                </div>
            ...
            <div class="card card-border card-info" id="mother-coil-data">
                <div class="card-header" style="background-image: linear-gradient(#e9f8ff, white);padding: 0px !important;">
                    <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered dt-responsive" id="datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead style="background: #393e4a59;">
                                                <tr>
                                                    <th colspan="5">Report Summary {{date('j M, Y ',strtotime(@$fromDate))}} To {{date('j M, Y ',strtotime(@$toDate))}}</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="4">Mother Coil</th>
                                                </tr>
                                                <tr>
                        ...
                        @if($mother_coils[0]->count_input_items_quantity)
                        <div class="row">
                                ...
                                <div id="printable-area" class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered dt-responsive" id="datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            @foreach($mother_coils as $mother_coil)
                                            <tbody>
                                                <td class="rig">{{$mother_coil['count_input_items_quantity']}}</td>
                                                <td class="rig">{{$mother_coil['metal_scrap_quantity']}}</td>
                                                <td class="rig">{{$mother_coil['invisible_quantity']}}</td>
                                                <td class="rig">{{$mother_coil['finished_goods_quantity']}}</td>
