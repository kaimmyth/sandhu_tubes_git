...
Sandhu Tubes Pvt. Ltd. is listed in Trade India's list of verified sellers offering supreme quality of etc. Buy in bulk from us for the best quality products and service.</p>
	...
	<section class="regional" id="regional-office" style="background: #efefef;padding: 3em;">
    ...
    <!--end of Regional Office -->
     ...
     <!--gallery section-->
     <section class="gallery" id="gallery" style="padding: 3em;background-color: rgba(57,62,74,1) !important;">
        <div class="container">
            <h3 class="heading" style="color: #fff;">Gallery</h3>
            <div class="row">
                <div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g1.png')}}"><img src="{{url('public/static-pages-assets/images/g1.png')}}" alt="img" ></a>
                </div>

                <div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g2.png')}}"><img src="{{url('public/static-pages-assets/images/g2.png')}}" alt="img" ></a>
                </div>

                <div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g3.jpg')}}"><img src="{{url('public/static-pages-assets/images/g3.jpg')}}" alt="img" ></a>
                </div>

                <div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g4.jpg')}}"><img src="{{url('public/static-pages-assets/images/g4.jpg')}}" alt="img" ></a>
                </div>
				
				
                  <div class="hh" style=" width: 100%; float: left; margin-bottom: 15px;"></div>
                <div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g5.jpg')}}"><img src="{{url('public/static-pages-assets/images/g5.jpg')}}" alt="img" ></a>
                </div>

                <div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g6.png')}}"><img src="{{url('public/static-pages-assets/images/g6.png')}}" alt="img" ></a>
                </div>
				<div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g10.jpg')}}"><img src="{{url('public/static-pages-assets/images/g10.jpg')}}" alt="img" ></a>

                </div>

                <div class="col-md-3">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g14.jpg')}}"><img src="{{url('public/static-pages-assets/images/g14.jpg')}}" alt="img" ></a>
                </div>
