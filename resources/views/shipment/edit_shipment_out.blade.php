                                                ...
                                                <div class="col-sm-12 row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="item_ids[]" id="item_ids" onchange="showserailno(this.value,append_i,this)">
                                                                <option value="" selected>--Select--</option>
                                                                @foreach($item_name_data as $kee=>$val1)
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="quantity[]" onchange="checkitemquantity(this.value,this)" id="quantity" value="{{$val->item_quantity}}" placeholder="Quantity">
