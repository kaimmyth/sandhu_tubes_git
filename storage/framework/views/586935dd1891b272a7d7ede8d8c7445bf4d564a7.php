                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <?php if(@$user_id!=1): ?>
                                            <?php if(@$module_permission['is_add']=='yes'): ?>
                                                <a href="<?php echo e(url('serviceManu/add')); ?>"><button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5" style="float:right;margin-top: 1%;"><i class="md md-add-circle-outline"></i> Add</button></a><br>
                                        ...
                                        <?php else: ?>
                                            <a href="#"><button id="prtbtn" onclick="printDiv('datatable ')" class="btn btn-purple btn-rounded waves-effect waves-light" style="float:right; margin-top:5%;">Print</button></a>
                                            <a href="<?php echo e(url('serviceManu/add')); ?>"><button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5 ttnne" style="float:right;margin-top: 1%;"><i class="md md-add-circle-outline"></i> Add</button></a><br>
                                        <?php endif; ?>
                                            ...
                                            <table id="datatable" class=" table table-striped table-bordered dt-responsive" style="border-collapse: collapse; width:100%; border-spacing: 0;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <td class="rig"><?php echo e($key_del + 1); ?></td>
                                                        <td><?php echo e(@$item_type->category_name); ?></td>
                                                        <td><?php echo e(@$service_type->service_name); ?></td>
                                                        <td><?php echo e(@$get_item_name->item_name); ?></td>
                                                        <td class="rig"><?php echo e(@$value_del['input_quantity']); ?> <?php echo e(@$uom->uom_name); ?></td>

                                                        <?php if(@$value_del['status']==1): ?>
                                                        <td>
                                                            <p class="mb-0">
                                                        ...
                                                        <?php endif; ?>
                                                        <td><?php echo e(date('j M, Y',strtotime(@$value_del['created_at']))); ?></td>
                                                        <td>
                                                            <?php if(@Auth::user()->id!=1): ?>
                                                                <?php if(@$module_permission['is_read']=='yes'): ?>
                                                                <a href="<?php echo e(url('serviceManu/view_details/'.$value_del['id'])); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="View" onclick=""><i class="fa fa-eye" style="color:green;"></i></a>
                                                                <?php endif; ?>
                                                                <?php if(@$module_permission['is_edit']=='yes'): ?>
                                                                <a href="<?php echo e(url('serviceManu/edit/'.$value_del['id'])); ?>" class="on-default view-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update"><i class="fas fa-edit"></i></a>
                                                                <?php endif; ?>
                                                                <?php if(@$module_permission['is_delete']=='yes'): ?>
                                                                <a href="<?php echo e(url('serviceManu/delete/'.$value_del['id'])); ?>" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash" style="color:red;"></i></a>
                                                                <?php endif; ?>
                                                            <?php else: ?>
                                                                <a href="<?php echo e(url('serviceManu/view_details/'.$value_del['id'])); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="View" onclick=""><i class="fa fa-eye" style="color:green;"></i></a>
                                                                <a href="<?php echo e(url('serviceManu/edit/'.$value_del['id'])); ?>" class="on-default view-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update"><i class="fas fa-edit"></i></a>
...
</script><?php /**PATH C:\xampp\htdocs\sandhu_tubes_git\resources\views/service/list.blade.php ENDPATH**/ ?>