                           ...
                           <tr>
                              ...
                              <td class="actions">
                                 <?php if(Auth::user()->id!=1): ?>
                                    ...
                                    <a href="<?php echo e(URL::to('department/destroy',$data->id)); ?>" class="on-default remove-row" onclick="return confirm('Are you sure you want to delete this item?');" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fas fa-trash" style="color:red;"></i></a>
                                    <?php endif; ?>
                                 <?php else: ?>
                                 <a href="javascript::void(0)" class="on-default edit-row" onclick="editRecords(<?php echo e($data->id); ?>)" data-toggle="tooltip" data-modal="modal-12" data-placement="top" title="" data-original-title="Edit"><i class="fas fa-edit"></i></a>
                                 &nbsp;&nbsp;&nbsp;
...
</script><?php /**PATH C:\xampp\htdocs\sandhu_tubes_git\resources\views/master/department.blade.php ENDPATH**/ ?>