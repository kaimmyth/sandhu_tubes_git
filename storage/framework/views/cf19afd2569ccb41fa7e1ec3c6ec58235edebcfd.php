  ...
  <div class="content">                                             
    ...
    <div class="container-fluid">
      ...
      <div class="row" id="dashboard-row">
        <div class="col-sm-12">
          <h4 class="pull-left page-title"  style="color: #000;font-weight:200;">&nbsp;<i class="ion-arrow-right-b"></i> &nbsp;&nbsp;Create Registration  <a href="javascript::void(0);"  onclick="history.back();" ></a></h4>
          ...
          <div class="card-header" style="background: linear-gradient(to left, #dbf2fd, #ffffff 50%, #ffffff, #ffffff 75%);">
                ...
                <div class="col-md-12">
                  <div class="row">
					...
					<label for="field-3" class="control-label">Kilograms</label>
                                ...
                                <select class="form-control" name="city" id="city" required="" aria-required="true">
                                  <option value=""></option>
                                  <option value="Jamshedpur">1000kg</option>
                                  <option value="Ranchi">2000kg</option>
			...
			<div class="row">
					...
					<label for="field-3" class="control-label">Kilograms</label>
                                ...
                                <select class="form-control" name="city" id="city" required="" aria-required="true">
                                  <option value=""></option>
                                  <option value="Jamshedpur">950 Kilograms</option>
                                  <option value="Ranchi">980 Kilograms</option>
				  ...
				  <div class="row">
					...
					<label for="field-3" class="control-label">Kilograms</label>
                                ...
                                <select class="form-control" name="city" id="city" required="" aria-required="true">
                                  <option value=""></option>
                                  <option value="Jamshedpur">47 Kilograms</option>
                                  <option value="Ranchi">47 Kilograms</option>
				  ...
				  <div class="row">
					...
					<label for="field-3" class="control-label">Kilograms</label>
                                ...
                                <select class="form-control" name="city" id="city" required="" aria-required="true">
                                  <option value=""></option>
                                  <option value="Jamshedpur">3 Kilograms</option>
                                  <option value="Ranchi">6 Kilograms</option>
  ...
  <div class="card">
    <div class="card-header">
     <div class="card-body"> 
      ...
      <?php endif; ?>
      <form action="<?php echo e(URL::to('land/create/registration')); ?>" id="basic-form" method="post" autocomplete="off">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="ids" value="<?php echo e($editData->id ?? ''); ?>">
        <input type="hidden" name="cust_id" value="<?php echo e($leaseData->cust_id ?? ''); ?>">
        <div>
          <h3>Land Details</h3>
          ...
          <section style="left: inherit;">
            ...
            <div class="col-md-10">
              <div class="row">
                <div class="col-md-3">
                  <p>Name : <b style="color: #F0560A" id="wc_name"><?php echo e($custData->f_name ?? ''); ?> <?php echo e($custData->l_name ?? ''); ?></b></p>
                </div>
                <div class="col-md-3">
                  <p>Phone No. :  <b style="color: #F0560A" id="wc_mobile"><?php echo e($custData->mobile ?? ''); ?></b></p>
                </div>
                <div class="col-md-3">
                  <p>Email :  <b style="color: #F0560A" id="wc_email"><?php echo e($custData->email ?? ''); ?></b></p>
                </div>
                <div class="col-md-3">
                  <p>Company :  <b style="color: #F0560A" id="wc_company"><?php echo e($custData->company ?? ''); ?></b></p>
                </div>
              </div>
            </div>
            <hr>
          ...
          <div class="row side">         
            <div class="col-md-5">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="registration_no" value="<?php echo e($leaseData->registration_no ?? ''); ?>" placeholder="">
                </div>
              </div> 
            </div>
            <div class="col-md-5">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control autodate" name="registration_date" value="<?php echo e($leaseData->registration_date ?? ''); ?>" placeholder="">
                </div>
              </div> 
            </div>
          </div>
          <div class="row side">
            <div class="col-md-5">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="application_no" value="<?php echo e($leaseData->application_no ?? ''); ?>" placeholder="">
                </div>
              </div> 
            </div>
            <div class="col-md-5">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control autodate" value="<?php echo e($leaseData->application_date ?? ''); ?>" name="application_date">
                </div>
              </div> 
            </div>
          </div>
          <div class="row side">
            <div class="col-md-5">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="allotment_no" value="<?php echo e($leaseData->allotment_no ?? ''); ?>" placeholder="">
                </div>
              </div> 
            </div>
            ...
            <div class="col-md-5">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control autodate" value="<?php echo e($leaseData->allotment_date ?? ''); ?>" name="allotment_date">
                </div>
              </div> 
            </div>
          </div>
          ...
          <div class="row side">
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control"  name="based_rent" id="based_rent" value="<?php echo e($leaseData->based_rent ?? ''); ?>" required="" aria-required="true">
                </div>
              </div> 
            </div>
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control"  name="insurance" id="insurance" value="<?php echo e($leaseData->insurance ?? ''); ?>" required="" aria-required="true">
                </div>
              </div> 
            </div>
            ...
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control"  name="maintanance" id="maintanance" value="<?php echo e($leaseData->maintanance ?? ''); ?>" required="" aria-required="true">
                </div>
              </div> 
            </div>
            ...
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control"   name="taxes" id="taxes" value="<?php echo e($leaseData->tax ?? ''); ?>" required="" aria-required="true">
                </div>
              </div> 
            </div>
            ...
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control"  name="additional_charge" id="additional_charge" value="<?php echo e($leaseData->additional_charge ?? ''); ?>" required="" aria-required="true">
                </div>
              </div> 
            </div>
          </div>
          ...
          <div class="row side">
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control"  name="netpaybill" id="netpaybill" value="<?php echo e($leaseData->net_pay ?? ''); ?>" readonly="" required="" aria-required="true">
                </div>
              </div> 
            </div>
            ...
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="radio radio-info form-check-inline" style="padding-left: 32px;">
                  <input type="radio" id="inlineRadio1" value="monthly" name="add_net_payable" <?php if(@$leaseData->net_payable='monthly'): ?> checked="checked" <?php endif; ?> id="net_payable">
                  <label for="inlineRadio1"> Monthly </label>
                </div>
                <div class="radio form-check-inline">
                  <input type="radio" id="inlineRadio2" value="yearly" name="add_net_payable" id="net_payable" <?php if(@$leaseData->net_payable='yearly'): ?> checked="checked" <?php else: ?> checked="checked" <?php endif; ?> style="width: 195px;">
            ...
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control"  name="lease_time" value="<?php echo e($leaseData->lease_time ?? ''); ?>"  required="" aria-required="true">
                  <input type="hidden" class="form-control" value="<?php echo e($leaseData->lease_duration ?? ''); ?>"  name="lease_duration" id="add_time_duration">
                </div>
              </div> 
            </div>
            ...
            <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                 <div class="input-group">
                  <input type="text" class="form-control autodate" placeholder="mm/dd/yyyy" name="start_date" id="start_date" value="<?php echo e($leaseData->start_date ?? ''); ?>" required="" aria-required="true">
...
<div id="add_customer" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
  <div class="modal-dialog"> 
    <div class="modal-content"> 
      ...
      <form action="<?php echo e(URL::to('land/customer/add')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data" autocomplete="off" >
        <?php echo csrf_field(); ?>
...
<div class="modal fade bs-example-modal-lg" id="add_land" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?php echo e(url('land/add')); ?>" method="post"  id="FormValidation"  required="" aria-required="true">
        <?php echo csrf_field(); ?>
        <div class="modal-body">
...
<script type="text/javascript">
 ...
 function Edit_Customer(id) {
  ...
  $.ajax({
    url: "<?php echo e(url('land/customer/edit/')); ?>" + '/' + id,
    method: "POST",
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $('#wsearchcustomer').on('keyup',function() {
      ...
      if (query != '') { 
       ...
       $.ajax({
        url: "<?php echo e(url('land/wserachcustomers/')); ?>" + '/' + query,
        type:"GET",
        success:function (data) {
          $("#loader1").css("display","none");
    ...
    $('#wsearchland').on('keyup',function() {
      ...
      if (query != '') { 
       ...
       $.ajax({
        url: "<?php echo e(url('land/wserachland/')); ?>" + '/' + query,
        type:"GET",
        success:function (data) {
          $("#loader1").css("display","none");
  ...
  function waddcustomer(id) { 
    ...
    $.ajax({
      url: "<?php echo e(url('land/wcustomer/add/')); ?>" + '/' + id,
      method: "POST",
      contentType: 'application/json',
      success: function(data) {
        console.log(data)
  ...
  function addlandwizard(id) {  
    ...
    $.ajax({
      url: "<?php echo e(url('land/land/wizard/add/')); ?>" + '/' + id,
      method: "POST",
      contentType: 'application/json',
      success: function(data) {
        console.log(data)
...
<?php /**PATH C:\xampp\htdocs\sandhu_tubes\resources\views/customer/create_registration.blade.php ENDPATH**/ ?>