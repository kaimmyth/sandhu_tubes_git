                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="field-3" class="control-label">Quantity*</label>
                        <input type="text" class="form-control" name="finished_goods_quantity" id="finished_goods_quantity" min="1" value="<?php if(@$manufacturing_details->finished_goods_quantity): ?> <?php echo e($manufacturing_details->finished_goods_quantity); ?> <?php endif; ?>" placeholder="" required="" aria-required="true">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="field-3" class="control-label">Quantity*</label>
                        <input type="text" class="form-control" name="metal_scrap_quantity" onblur="check_quantity();" id="metal_scrap_quantity" min="1" value="<?php if(@$manufacturing_details->metal_scrap_quantity): ?> <?php echo e($manufacturing_details->metal_scrap_quantity); ?> <?php endif; ?>" placeholder="" required="" aria-required="true">
                      </div>
                    </div>
