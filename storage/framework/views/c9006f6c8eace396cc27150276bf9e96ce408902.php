  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="row" id="dashboard-row">
        <div class="col-sm-12">
          <h4 class="pull-left page-title" style="color: #000; font-weight:200;"><i class="ion-arrow-right-b"></i> &nbsp;&nbsp;<?php if(@$editData->id!=''): ?> Update Land Info <?php else: ?> Create Inventory
 <?php endif; ?>  <a href="javascript::void(0);" onclick="history.back();"></a></h4>
          <ol class="breadcrumb pull-right">
            <li><a href="<?php echo e(URL::to('home')); ?>">Home</a></li>
            <li><a href="<?php echo e(URL::to('home')); ?>">Inventory</a></li>
            ...
            <div class="card-header" style="background: linear-gradient(to left, #6e5e5c, #ffffff 50%, #ffffff, #ffffff 75%);">
              <div class="card-body">
                ...
                <div class="col-md-12" style="    text-align: left; margin-bottom: 6px;">
                  <button type="submit" class="btn btn-success waves-effect waves-light m-b-5"><?php if(@$editData->id!=''): ?> Update <?php else: ?> Create <?php endif; ?></button>
                </div>
                </form>
...
</div><?php /**PATH C:\xampp\htdocs\sandhu_tubes\resources\views/land/add_land.blade.php ENDPATH**/ ?>