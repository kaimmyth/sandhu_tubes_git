    ...
    <div class="innerf-pages section" style="padding: 2em;">
		...
		<div class="fh-container mx-auto">
            ...
            <div class="input-group mb-3" style="margin-top:1em;">
                <input type="text" class="form-control" placeholder="Search doctors, clinics, hospitals, etc." style="width: 73%;margin: 0 auto;">
            ...
            <div  id="company_details">
                ...
                <div class="col-md-9 job-post-info text-left" style="margin-top:4px;" >
                    ...
                    <div class="job-post-icon">
                       <img src="<?php echo e(url('public/images/company/'.$value_comp->company_logo)); ?>">
                    </div>
                    <div class="job-single-sec">
                        <p class="my-2"><a href="<?php echo e($value_comp['company_portal_url']); ?>"><?php echo e($value_comp['company']); ?></a>  <span class="etlk">(<?php echo e($value_comp['company_type']); ?>)</span></p>
                        <!-- <ul class="job-list-info">
                            <li>
                                <i class="fas fa-briefcase"></i> <?php echo e($value_comp['company_type']); ?></li>
                            <li>
                                <i class="fas fa-map-marker-alt"></i><?php echo e($value_comp['address']); ?></li>
                            <li>
                                <i class="fas fa-rupee-sign"></i><?php echo e($value_comp['turn_over']); ?></li>
                        </ul> -->
                        <ul class="job-list-info">
                          <!-- <li>
                                <i class="fas fa-briefcase"></i> <?php echo e($value_comp['company_type']); ?></li>-->
                            ...
                            <?php if($value_comp['company_portal_url']!=""): ?>    <li class="cllrr">
                                <i class="fa fa-globe cllrr"></i><?php echo e($value_comp['company_portal_url']); ?></li>
                                <?php endif; ?>
                        </ul>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\sandhu_tubes\resources\views/static-pages/unit.blade.php ENDPATH**/ ?>