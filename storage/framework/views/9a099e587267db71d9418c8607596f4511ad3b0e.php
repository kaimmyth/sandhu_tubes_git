	...
	<div id="wrapper">
		...
		<div class="topbar">
			...
			<div class="topbar-left" style="background: #393e4a;border: 2px solid #393e4a;">
				<div class="text-center">
					<a href="<?php echo e(url('dashboard')); ?>" class="logo">
						<span><span><img src="<?php echo e(url('public/assets/images/sandhu_tubes.png')); ?>" style="height: 68px;"></span></a></span></a>
				...
				<nav class="navbar navbar-default">
					<div class="container-fluid">
						<ul class="list-inline menu-left mb-0">
							...
							<!--<img src="<?php echo e(asset('public/form/images/toplogo.png')); ?>" style="height:60px;float:left;margin-left: 9px;">-->
								<form role="search" class="navbar-form">
									<h4 style="margin-top: 16px;color: #fff;">Sandhu Tubes</h4>
								</form>
						...
						<ul class="nav navbar-left float-left" >
							...
							<!-- 	<li><img src="<?php if(@$logo->logo!=''): ?> <?php echo e(@$logo->logo); ?> <?php else: ?> <?php echo e(asset('public/form/images/log.png')); ?> <?php endif; ?>" height="50" width="50" alt="user-img" class="rounded-circle"></li> -->
            ...
            <li class="dropdown open">
            	...
            	<a href="#" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src=" <?php echo e(asset('public/assets/images/users/avatar-1.jpg')); ?> " alt="user-img" class="rounded-circle"> &nbsp;&nbsp;admin </a>
